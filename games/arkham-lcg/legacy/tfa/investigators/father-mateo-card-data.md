# Father Mateo — Card Data Reference
...
| Health | 6 |
| Sanity | 8 |
| Ability text | <reaction> When an investigator reveals an <auto_fail> chaos token: Cancel that token and treat it as an <elder_sign> token, instead. (Limit once per game.)
...
You get +1 <wil> while there is a token sealed here.
...
| Skill Icons | <wil> <wild> |

## Personal Weakness (04014)
| Field | Value |
|---|---|
| Type | Enemy (Weakness) |
...
| Flavor | *"I know not what Yig is, but I know I have wounded his children." - Father Mateo, <u>Investigators of Arkham Horror</u>* |
