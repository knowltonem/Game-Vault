# Mark Harrigan — Card Data Reference
...
| Health | 9 |
| Sanity | 5 |
| Ability text | You begin the game with Sophie <i>(In Loving Memory)</i> in play.
...
| Flavor text | *He'd burn the entire town down if necessary, but he wouldn't let those monsters take anyone else.* |
| Collection | 03001 |
...
| Deckbuilding Requirements | The Home Front (× 1), Shell Shock (× 1), Sophie (× 1), 1 random Basic Weakness |
...
## Signature Asset — The Home Front (03007)
| Field | Value |
|---|---|
| Type | Skill |
...
| Skill Icons | <com> <com> <com> <com> |
| Flavor | *The real war has only just begun.* |

## Personal Weakness (03008)
| Field | Value |
|---|---|
...
## Signature Asset — Sophie (In Loving Memory) (03009)
| Field | Value |
|---|---|
| Type | Asset |
| Traits | *Item. Spirit.* |
...
<fast> Take 1 direct damage: You get +2 to your skill value for this skill test.
