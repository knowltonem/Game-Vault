# Minh Thi Phan — Card Data Reference
...
| Health | 7 |
| Sanity | 7 |
| Ability text | <reaction> After an investigator at your location commits a card to a skill test: That card gains a <wild> icon until the end of the test. (Limit once for each investigator per round.)
...
| Flavor text | *"You can depend on me to guide you through the unknown."* |
| Collection | 03002 |
