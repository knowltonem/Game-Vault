# William Yorick — Card Data Reference
...
| Health | 8 |
| Sanity | 6 |
| Ability text | <reaction> After you defeat an enemy: Play an asset from your discard pile <i>(paying its cost)</i>. (Limit once per round.)
<elder_sign> effect: +2. If this test is successful, return 1 card from your discard pile to your hand. |
| Flavor text | *"I am but a simple player in this drama, but if I am lucky, I'll live to see the curtains fall."* |
| Collection | 03005 |
