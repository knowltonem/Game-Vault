# Amanda Sharpe — Card Data Reference
...
| Health | 7 |
| Sanity | 7 |
| Ability text | <b>Forced</b> - At the start of the investigation phase: Draw 1 card. Discard the card beneath Amanda Sharpe. Choose a card from your hand and place it beneath her.
...
| Class | Seeker |
| Deck Size | 30 |
| Deckbuilding Options |   • Seeker, Neutral (level 0–5)<br>  •  (level 0–3) |
| Deckbuilding Requirements | Obscure Studies (× 1), Whispers from the Deep (× 1), 1 random Basic Weakness |
...
## Signature Asset — Obscure Studies (07008)
| Field | Value |
|---|---|
| Type | Event |
| Traits | *Insight.* |
...
| Skill Icons | <wild> <wild> <wild> |

## Personal Weakness (07009)
| Field | Value |
|---|---|
| Type | Skill (Weakness) |
| Traits | *Curse.* |
