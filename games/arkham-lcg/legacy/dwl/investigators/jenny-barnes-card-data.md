# Jenny Barnes — Card Data Reference
...
| Health | 8 |
| Sanity | 7 |
| Ability text | You collect 1 additional resource during each upkeep phase.
<elder_sign> effect: +1 for each resource you have. |
| Flavor text | *"No more 'Miss Barnes' from you. My friends call me Jenny."* |
| Collection | 02003 |
...
<action> Spend 1 ammo: <b>Fight.</b> You get +2 <com> for this attack. This attack deals +1 damage. |
| Skill Icons | <agi> <agi> <wild> |
...
<b>Forced</b> - When the game ends, if Searching for Izzie is in play: Jenny Barnes suffers 1 mental trauma. |
