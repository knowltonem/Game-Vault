...
| Modified | `Outpost 31 - Mod/` | All new/changed material: extracted card data, corrected text, art redirects, logs. |
...
## Naming
- All top-level scenario folders: `Outpost 31 - {Descriptor}/` (title case, spaces, with dash).
