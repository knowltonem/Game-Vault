...
| Icon | Meaning |
|---|---|
| 🔴 BLOCKED | Waiting on data from Claude Desktop |
| 🟡 QUEUED | Data received, ready for Strange Eons |
...
| File | Status | Notes |
|---|---|---|
| `Outpost 31 Scenario Guide.pdf` | ❓ TBD | May need text edits for "protocols", "helicopter", etc. |
| `Outpost 31 (Card List).doc` | ❓ TBD | May need card name updates |
| `Scenario page Title Art.png` | ❓ TBD | May want to add "A Prologue to Edge of the Earth" |
