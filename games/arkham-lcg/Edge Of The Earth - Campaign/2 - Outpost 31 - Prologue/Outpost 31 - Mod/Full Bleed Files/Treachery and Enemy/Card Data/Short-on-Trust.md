# Short on Trust
**Type:** Treachery | **Trait:** Mystery. | **Copies:** 2 (#58, #59)
**Illustrator:** Sergey Cherenkov | **Encounter:** Snowflake | **Set:** II | **Status:** ?? QUEUED (text fix)
**Revelation:** You must either (choose one):
- Place 1 suspicion on each card at your location (investigators, allies, and Crew Members).
