# Abraham Setrakian — Investigator Pack (RYP-AS)
...
If this test fails, draw 2 cards.
```
*Custom variant — official card (ArkhamDB #01093) has no bonus effects; risk/reward balance added.*
