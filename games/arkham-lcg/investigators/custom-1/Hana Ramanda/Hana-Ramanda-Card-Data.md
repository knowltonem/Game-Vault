# Hana Ramanda — Investigator Pack (RYP-HR)
...
### Ability
```
<fre> Once per round: Disengage from
each enemy engaged with you and move
...
### Elder Sign
```
<eld> +2. Draw 3 cards. You may
immediately play 1 card from your
hand at no cost.
```
