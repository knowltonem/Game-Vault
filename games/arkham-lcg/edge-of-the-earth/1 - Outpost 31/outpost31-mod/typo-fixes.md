...
> Card-data `.md` files already hold the corrected text; this list is what still needs fixing **on the card art itself**.

Legend: ☐ = to do on art · ✏️ grammar/spelling · 🔠 capitalization · ❓ decision needed
...
### Repair Protocols (#31)
- ✅ DONE (data): "Helicopter Pad" → "Ice Runway" reference fix applied in card-data.
- ☐ ✏️ On art, confirm the ability reads **"remove 1 damage from Ice Runway"** (was "Helicopter Pad").
